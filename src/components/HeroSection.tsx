        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto mb-8 sm:mb-12">
            <p className="text-white text-lg sm:text-xl lg:text-2xl leading-relaxed tracking-wide">
              <span className="font-bold">Handcrafted by our expert Hatton Garden Jewellers,</span>{" "}
              <span className="font-medium">
                our diamond engagement rings are British heritage, heirloom-quality pieces. 
                Every ring is a promise: exquisitely designed, consciously crafted and perfected to last lifetimes.
              </span>
            </p>
