...
export default function ShopByStyleSection() {
  ...
  const ringStyles: RingStyle[] = [
    {
      ...
      image: "https://cdn.builder.io/api/v1/image/assets%2F82ac9eba2533469a871410336fa61e14%2F8e37fc8d00724697b9741ed9601cfad3?format=webp&width=800",
      alt: "Oval three stone engagement ring with pear side stones"
    },
    {
      id: "oval-cluster",
      title: "Oval Cluster",
      image: "https://cdn.builder.io/api/v1/image/assets%2F82ac9eba2533469a871410336fa61e14%2F825abc1c653744efb183237dc044e66c?format=webp&width=800",
      alt: "Oval center stone with diamond cluster band"
    },
    {
      id: "pear-halo",
      title: "Pear Halo",
      image: "https://cdn.builder.io/api/v1/image/assets%2F82ac9eba2533469a871410336fa61e14%2F494f788903b8478abf0bf1d5404c70c0?format=webp&width=800",
      alt: "Pear shaped diamond with halo setting"
    },
    {
      id: "round-solitaire",
      title: "Round Solitaire",
      image: "https://cdn.builder.io/api/v1/image/assets%2F82ac9eba2533469a871410336fa61e14%2Ff2e46a5e919542e1882db3b2c3bf51a2?format=webp&width=800",
      alt: "Classic round solitaire engagement ring"
    },
    {
      id: "emerald-bezel",
      title: "Emerald Bezel",
      image: "https://cdn.builder.io/api/v1/image/assets%2F82ac9eba2533469a871410336fa61e14%2F941f08162843438ba5d80c1639a9b56a?format=webp&width=800",
      alt: "Emerald cut diamond in bezel setting"
    },
    {
      id: "vintage-oval",
      title: "Vintage Oval",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/f258bf9cca6ca64de0cd4a589bbe5ba42b9353b2?width=1265",
      alt: "Vintage inspired oval engagement ring"
    },
    {
      id: "classic-round",
      title: "Classic Round",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/6d9e98c2214e077b8ce57ab5061d3aa94c389c44?width=1023",
      alt: "Classic round diamond engagement ring"
    },
    {
      id: "modern-cushion",
      title: "Modern Cushion",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/613c00fdec0bc81f309737405c1a06af29a3cd25?width=1034",
  ...
  const prevSlide = () => {
    setCurrentSlide((prev) => (prev - 1 + ringStyles.length) % ringStyles.length);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-black text-base lg:text-lg leading-relaxed max-w-4xl mx-auto font-medium">
            Browse our exclusive engagement ring designs by categories and explore a range of timeless or modern styles 
            to pair with your selected lab-grown or earth-mined diamond. Our engagement rings embody over a decade of 
            expertise and uncompromising quality, specific only to Hatton Garden Jewellers & Craftsmen.
          </p>
        </div>
          ...
          <div className="mx-16">
            ...
            <div className="hidden lg:grid lg:grid-cols-3 gap-8">
              {getVisibleSlides().map((ring, index) => (
                <div 
                  ...
                  onClick={() => goToSlide((currentSlide + index) % ringStyles.length)}
                >
            ...
            <div className="lg:hidden">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {getVisibleSlides().slice(0, 2).map((ring, index) => (
                  <div 
                    key={`${ring.id}-${currentSlide}-${index}`}
                    className="group cursor-pointer"
                    onClick={() => goToSlide((currentSlide + index) % ringStyles.length)}
