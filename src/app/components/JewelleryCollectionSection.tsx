  ...
  const collections = [
    {
      ...
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/16ed31e4e075f6ce9a18bbef0964305656dfd5b0?width=803',
      overlayImages: [
    ...
    {
      name: 'Wedding Rings',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/6f8fcad43172f2ec937885e62a6c57070a435633?width=803',
      overlayImages: [
    ...
    {
      name: 'Necklaces',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/d3a7cb6b1ff7abf12d4a4057f236aaf31f21c153?width=803',
      overlayImages: [
    ...
    {
      name: 'Bracelets',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/9f477a64986008b15ae0744e0eaec0e072792e9c?width=803',
      overlayImages: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-helvetica text-xl font-medium text-secondary leading-[150%] tracking-[-0.22px] max-w-5xl mx-auto">
            Our collection of jewellery features stunning rings, <span className="text-secondary">wedding bands</span>, <span className="text-secondary">pendants</span>, <span className="text-secondary">bracelets</span> and more, all crafted with the finest diamonds and heritage techniques.
          </p>
        </div>
                ...
                {collection.overlayImages.map((overlayImg, imgIndex) => (
                  ...
                  >
                    <Image
                      ...
                      height={imgIndex === 0 ? 551 : imgIndex === 1 ? 1360 : 576}
