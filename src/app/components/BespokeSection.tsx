          ...
          <div className="flex-1">
            <div className="mb-6">
              <span className="font-hiragino text-base font-semibold text-black tracking-[-0.176px] block mb-4">
                Go on a journey to design your ring from scratch, with one of our expert jewellers in Hatton Garden, London.
              </span>
            </div>
              ...
              <div key={index} className="relative">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex-1 ml-8">
                    <svg width="783" height="3" viewBox="0 0 784 3" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0.345337 1.19385H783.345H0.345337Z" fill="#806C63"/>
                      <path d="M0.345337 1.19385H783.345" stroke="#806C63" strokeWidth="2.4006"/>
                    </svg>
                  </div>
                  
                  <div className="ml-4">
                    <svg width="42" height="21" viewBox="0 0 42 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3.84534 1.80273L21.3326 16.4102L38.8473 1.81348L39.1647 1.54883L39.484 1.81055L40.6617 2.77344L41.1305 3.15625L40.6656 3.54395L21.652 19.3916L21.3317 19.6592L21.0114 19.3916L2.02502 3.53223L1.56018 3.14355L2.02893 2.76074L3.20862 1.79883L3.52795 1.53809L3.84534 1.80273Z" fill="#806C63" stroke="#806C63"/>
                    </svg>
                  </div>
                </div>
              </div>
