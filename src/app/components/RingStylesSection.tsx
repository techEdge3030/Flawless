...
export default function RingStylesSection() {
  const ringStyles = [
    {
      name: 'Trilogy',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/ada194cfd62bbfbc7fcaa06bbaa45fdf2dafd553?width=658',
      overlayImages: [
    ...
    {
      name: 'Solitaire',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/6da5b7432687e809b74f23583c48ce79096dfc98?width=1070',
      overlayImages: [
    ...
    {
      name: 'Cluster',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/ccd55977c59fe0d90a6241733df3c8eb269f1957?width=1176',
      overlayImages: [
    ...
    {
      name: 'Bezel',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/b5805d144ffb26184f4475427fa356cef583c464?width=1300',
      overlayImages: [
    ...
    {
      name: 'Hidden Halo',
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/281cbb67b738917be02d4dc56320f171308a9166?width=1004',
      overlayImages: [
        ...
        <div className="grid grid-cols-5 gap-6 mb-8">
          {ringStyles.map((style, index) => (
            <div key={style.name} className="group cursor-pointer">
              ...
              <h3 className={`font-hiragino text-[22px] font-semibold text-black text-center leading-[150%] tracking-[-0.242px] ${
